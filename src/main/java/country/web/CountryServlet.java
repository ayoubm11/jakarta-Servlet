...
public class CountryServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (countryName != null && !countryName.trim().isEmpty()) {
            ...
            if (success) {
                System.out.println("Pays ajouté avec succès : " + countryName);
            } else {
                System.out.println("Erreur lors de l'ajout du pays !");
            }
        }
        displayCountries(request, response);
    }
    ...
    private void displayCountries(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Correction ici : récupérer la session correctement
